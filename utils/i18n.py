...
_T: dict[str, dict[str, str]] = {
    ...
    "SETTINGS_ANSCHREIBEN":   {"tr": "Hazır Anschreiben:",              "de": "Fertiges Anschreiben:",               "en": "Pre-written Cover Letter:"},
    "SETTINGS_ANSCHREIBEN_HINT":{"tr": "(Dolu ise AI çağrısı yapılmaz; bu metin doğrudan kullanılır)",
                               "de": "(Wenn ausgefüllt, wird kein KI-Aufruf gemacht; dieser Text wird direkt verwendet)",
                               "en": "(If filled, no AI call is made; this text is used directly)"},
